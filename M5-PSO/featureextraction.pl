...
@attribute CGCGGA numeric
@attribute CTCGAC numeric
@attribute GCACGC numeric
...
$feature{$id}{CGCGGA} = frequence($sixref->{"CGCGGA"},$sixref->{total});
$feature{$id}{CTCGAC} = frequence($sixref->{"CTCGAC"},$sixref->{total});
$feature{$id}{GCACGC} = frequence($sixref->{"GCACGC"},$sixref->{total});
...
print $feature{$id}{CGCGGA}." , "; 
print $feature{$id}{CTCGAC}." , "; 
print $feature{$id}{GCACGC}." , ";
